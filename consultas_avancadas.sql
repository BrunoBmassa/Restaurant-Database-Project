...
-- Selecione Preço superior a 30
SELECT nome, categoria FROM produtos WHERE preco > 30;

-- Selecione clientes que nasceram antes do ano de 1985
...
SELECT nome, descricao, preco FROM produtos WHERE categoria = 'Prato Principal' ORDER BY id_produto LIMIT 2 OFFSET 5;
